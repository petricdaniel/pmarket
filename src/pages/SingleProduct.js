        ...
        <div className="row">
          <div className="col-6">
            ...
            <div className="other-product-images d-flex flex-wrap gap-15">
              <div>
                <img
                  src="https://www.stylebud.com/cdn/shop/products/WW1749LIGE8950Watch_2_250x.jpg?v=1673973805"
                  className="img-fluid"
                  alt=""
                />
              </div>
              <div>
                <img
                  src="https://ae01.alicdn.com/kf/Scd3427d90bab4a028568c69f937a70c9t.jpg_640x640Q90.jpg_.webp"
                  className="img-fluid"
                  alt=""
                />
              </div>
              ...
              <div className="py-3">
                ...
                <div className="d-flex gap-10 flex-column my-3">
                  ...
                  <p className="product-data">
                    ...
                    We ship 165 all US domestic orders within
